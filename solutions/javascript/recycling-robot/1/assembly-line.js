...
export function isNumber(value) {
  return "number" === typeof value && isFinite(value) || "bigint" === typeof value ;
}
...
export function isNumericString(value) {
  return "string" === typeof value && isFinite(Number(value)) && value.trim() !== "";
}
...
export function hasIdProperty(object) {
  return Object.hasOwn(object, "id") ? true : false;
...
export function hasDefinedType(object) {
  return object.type !== undefined && Object.prototype.hasOwnProperty.call(object, "type") ? true : false;
}
